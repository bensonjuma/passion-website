...
<section class="home" id="home">
    ...
    <div class="content">
        ...
        <p>
            We are a web design and development agency committed to creating beautiful, user-friendly, and engaging experiences. Join us by getting started below.</p>
    ...
    <div class="row">
        ...
        <div class="content">
          ...
          <p>  click below to learn more...</p>
            <a href="login.php?#services" class="btn">learn more</a>
        </div>
        <div class="image">
...
<section class="blogs" id="blogs">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="content">
                <a href="blog1" class="title">Web Design Ledger</a>
                <span>by admin / 1st november, 2022</span>
                <p>The Web Design Ledger blog is a great resource for web designers, developers, and entrepreneurs. From tutorials and tips to news and trends, our blog is full of helpful information to help you make the most of your website and online presence. We cover topics such as web design, development, SEO, content marketing, and more. Our goal is to...</p>
                <a href="login.php#blogs" class="btn">read more</a>
            </div>
        </div>
